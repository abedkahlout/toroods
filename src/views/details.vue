      ...
      <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-body pt-15">
          ...
          <div class="d-flex flex-center flex-column mb-5">
            ...
            <!--begin::Position-->
            <div class="fs-5 fw-bold text-muted mb-6">مهندس برمجيات</div>
            <!--end::Position-->
          ...
          <div id="kt_customer_view_details" class="collapse show">
            <div class="py-5 fs-6">
              ...
              <!--begin::Details item-->
              <!--begin::Details item-->
              <div class="fw-bolder mt-5">رقم الهوية</div>
              ...
              <!--begin::Details item-->
              <!--begin::Details item-->
              <div class="fw-bolder mt-5"> صلاحيته</div>
...
import PaymentRecords from "@/components/customers/cards/overview/PaymentRecords3.vue";
